...
namespace MicroApp.Identity.Api.Domain
{
    public class User : IIdentifiable
    {
        ...
        public User(Guid id, string email, string role)
        {
            ...
            {
                throw new MicroAppException(Codes.InvalidEmail,
                    $"Invalid email: '{email}'.");
            }
            
            if (!Domain.Role.IsValid(role))
            {
                throw new MicroAppException(Codes.InvalidRole,
                    $"Invalid role: '{role}'.");
            }
            Id = id;
        ...
        public void SetPassword(string password, IPasswordHasher<User> passwordHasher)
        {
            ...
            {
                throw new MicroAppException(Codes.InvalidPassword,
