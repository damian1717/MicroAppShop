...
namespace MicroApp.Common.Handlers
{
	public class Handler : IHandler
	{
        ...
        private Func<MicroAppException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<MicroAppException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (MicroAppException customException)
            {
                isFailure = true;
